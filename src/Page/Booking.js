...
<div className='mt-5 text-center'><span className='text-light'style={{fontSize:"25px"}}>{props.b2}</span> <span className='ms-5 text-light' style={{fontSize:"25px"}}>keval@domain.com</span> <span className='ms-5 text-light' style={{fontSize:"25px"}}>34-D, surendranagar, KP</span> </div>

<hr className='mt-5'/>
<div className='text-center text-light pb-5' style={{fontSize:"20px"}}>Copyright © Kevalprajapati | ahmedabad,naroda-382330</div>
</div>
    </>
  )
}
